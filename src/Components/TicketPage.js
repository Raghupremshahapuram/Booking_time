    ...
    <div className="container mt-5 ticket-page printable-card">
      <div className="card shadow rounded-4 overflow-hidden">
        ...
        <div className="ticket-header text-white px-4 py-3 d-flex justify-content-between align-items-center">
          <div>
            <h4 className="mb-1">
              <i className="bi bi-ticket-perforated-fill me-2"></i>Cinema Ticket
            </h4>
            <small>
          ...
          <div className="flex-grow-1">
            ...
            <div className="row text-center">
              ...
              <div className="col">
                ...
                <br />
                <strong>{new Date(created_at || date).toLocaleDateString()}</strong>
              </div>
            </div>
          </div>

          {/* Right: QR code + Poster */}
          <div className="d-flex flex-column align-items-center justify-content-center text-center" style={{ minWidth: '180px' }}>
            <QRCodeCanvas
              value={generateQRString()}
              size={140}
              className="bg-white p-2 rounded shadow-sm mb-3"
            />
            <p className="small text-muted mb-2">Scan this QR at the entrance</p>
            <img
              src={image}
              alt="Poster"
              className="img-fluid rounded shadow-sm"
